...
// This program is an extension from 2.4.1.cpp, where the descriptions of classes are printed with ToString functions.
// In this version, we remove all the ToString function and instead use operator overloadings to print the descriptions.
