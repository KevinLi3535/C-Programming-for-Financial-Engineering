// Testexponential.cpp
// Author: Minghan Li
// The code is modified from Testexponential.cpp by (C) Datasim Education BV 2009-2011

// Instruction:
// Modify the code in the file “TestNormalDistribution.cpp” to work with exponential
// distribution instead of normal distributionand Poisson distribution instead of gamma
// distribution.
...
int main()
{
	...
	// Choose another data type and now use default parameters for exponential distribution
	...
	cout << "\n***poisson distribution: \n";
	double mean = 3.0;	// Parameter for Poisson distribution
